...
### Инсталиране:  
1) Изтеглете файла __fakturiraneeu.ocmod.zip__ от [GitHub](https://github.com/evtimov/oc3-supto-importer/releases/download/1.0.1/fakturiraneeu.ocmod.zip) или официалния сайт на [OpenCart](https://www.opencart.com/index.php?route=marketplace/download&extension_id=37065);
