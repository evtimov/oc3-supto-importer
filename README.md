...
### Инсталиране:  
1) Изтеглете файла __oc3-supto-importer-1.0.3.zip__ от [GitHub](https://github.com/evtimov/oc3-supto-importer/archive/1.0.3.zip) или официалния сайт на [OpenCart](https://www.opencart.com/index.php?route=marketplace/download&extension_id=37065);
